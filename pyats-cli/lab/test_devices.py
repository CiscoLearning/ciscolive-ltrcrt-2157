...
for device_name, device in testbed.devices.items():
    ...
    device_config = device.  # <TODO> - Add a parser to obtain the running configuration

    for command in command_list:
        try:
            assert # <TODO> - Build an assertion to test that the command exists in the running-config
